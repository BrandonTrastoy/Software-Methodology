...
public class StudentList {
	...
	/**
	 * This method is made for the GUI, adds students to the list and outputs to
	 * display.
	 * 
	 * @param display is the location to send output
	 * @param s       instance of Student to add
	 */
	public void addForGUI(TextArea display, Student s) {
		...
		if (isEmpty() == true) {
			...
			sList[0] = s;
			numStudents += 1;
			display.setText(String.valueOf("Student added to list."));
		} else if (sList[0] == null) {
			...
			// Check if member already exists before adding
			if (contains(s)) {
				display.setText(String.valueOf("Student already in list."));
				return;
			}
	...
	/**
	 * This method is made for the GUI, removes students from the list and outputs
	 * to display.
	 * 
	 * @param display is the location to send output
	 * @param s       instance of Student to remove
	 */
	public void removeForGUI(TextArea display, Student s) {
		...
		if (index == NOT_FOUND) {
			display.setText(String.valueOf("Student Not Found"));
			return;
		}
		...
		display.setText(String.valueOf("Student Removed"));

	}

	/**
	 * This method is made for the GUI, prints all students in the list to display.
	 * 
	 * @param display is the location to send output
	 */
	public void printToGUI(TextArea display) {
		...
		if (isEmpty() || sList[i] == null) {
			...
			display.setText(String.valueOf("No students enrolled!"));
			return;
		}

		display.setText(display.getText() + String.valueOf("We have the following students: \n"));

		for (i = 0; i < sList.length; i++) {
			if (sList[i] != null)
				display.setText(display.getText()
						+ String.valueOf(sList[i].toString() + "Tuition Due = $" + sList[i].tuitionDue()) + "\n");
		}

		display.setText(String.valueOf(display.getText() + "-- end of the list -- \n"));
	}
